package ch.inofix.timetracker.background.task.display;
...
/**
 * Based on the model of com.liferay.exportimport.background.task.display.
 * ExportImportBackgroundTaskDisplay
 *
 * @author Christian Berndt
 * @created 2017-04-04 23:50
 * @modified 2017-04-04 23:50
 * @version 1.0.0
 *
 */
public class ExportImportBackgroundTaskDisplay extends BaseBackgroundTaskDisplay {
    ...
    protected TemplateResource getTemplateResource() {
        ...
        return new URLTemplateResource(_DETAILS_TEMPLATE, classLoader.getResource(_DETAILS_TEMPLATE));
    }
    ...
    private static final String _DETAILS_TEMPLATE = "com/liferay/exportimport/background/task/display/dependencies"
